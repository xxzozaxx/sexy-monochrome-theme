;;; simple-monochrome-theme.el --- A simple dark Emacs >= 24 theme for your simple code
;; it just fork from sexy-monochrome-theme
...
;; foker: Ahmed Khaled
;; Keywords: themes
;; URL: https://github.com/xxzozaxx/sexy-monochrome-theme
;; Version: 1.0
...
;; just fork form sexy-monochrome-theme
;; URL: https://github.com/voloyev/simple-monochrome-theme

;; which Based on the Xavier Noria monochrome-theme
...
(let ((class '((class color) (min-colors 10)))
  ...
  (custom-theme-set-faces
   ...
   `(link ((,class (:underline t :foreground ,link))))
   `(link-visited ((,class (:underline t :foreground ,linkv))))
